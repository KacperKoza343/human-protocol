...
export const ConfigNames = {
  ...
  CAMPAIGN_EXCHANGE_ORACLE_ADDRESS: 'CAMPAIGN_EXCHANGE_ORACLE_ADDRESS',
  CAMPAIGN_EXCHANGE_ORACLE_WEBHOOK_URL: 'CAMPAIGN_EXCHANGE_ORACLE_WEBHOOK_URL',
...
export const envValidator = Joi.object({
  ...
  FORTUNE_EXCHANGE_ORACLE_ADDRESS: Joi.string(),
  CVAT_EXCHANGE_ORACLE_ADDRESS: Joi.string(),
  ...
  CAMPAIGN_EXCHANGE_ORACLE_ADDRESS: Joi.string(),
  CAMPAIGN_EXCHANGE_ORACLE_WEBHOOK_URL: Joi.string().default('http://localhost:3006'),
